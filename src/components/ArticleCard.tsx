...
const ArticleCard: React.FC<ArticleCardProps> = ({article,onEdit,onDelete})=> {
  return (
    <div className="flex p-4 bg-white w-[40rem] mb-6 ml-[2rem] shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
        ...
        <div className="m-6 fkex-1 flex flex-col">
            <h3 className="text-xl font-semibold text-black">{article.title}</h3>
            <p className="text-sm text-gray-800 flex-1">{article.description}</p>
            <div className="flex items-center jusitfy-between mt-4 text-gray-700">
